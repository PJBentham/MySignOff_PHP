...
<html lang="en">
  <head>
	...
	function uploadFile(){
	  ...
	  ajax.open("POST", "../../assets/php/actionlocker.php", true);
	  ajax.send(formdata);
	}
...
<body>	
	<div id="body1">
		...
		<form method="post" action="../../assets/php/actionlocker.php" id="form1" name='mainForm' enctype="multipart/form-data">
		...
		<input type="textarea" name="FitterComments" placeholder="Fitter Comments..."/><br>
		<hr>
		...
		<p>You were able to complete everything required before the fitter arrived to carry out the work (if applicable)  (If no tasks required, then mark True)</p>
